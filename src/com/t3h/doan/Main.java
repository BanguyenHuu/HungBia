...
public final class Main extends javax.swing.JFrame {
    ...
    public void initPanel() {
        pnMain = new myGame("/images/background.png", 600, 600);
        pnGirl = new JPanel();
        lbGirl = new JLabel();
    ...
    private void initComponents() {
        ...
        lbCap1 = new JLabel();
        lbCap2 = new JLabel();
        lbScoreLayout = new JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setPreferredSize(new Dimension(1000, 600));
        getContentPane().setLayout(null);

        pnScore.setPreferredSize(new Dimension(100, 600));
        pnScore.setLayout(null);
        pnScore.add(lbCup);
        lbCup.setBounds(30, 20, 60, 180);

        lbCap3.setMaximumSize(new Dimension(34, 30));
        lbCap3.setMinimumSize(new Dimension(10, 10));
        pnScore.add(lbCap3);
        ...
        lbScoreLayout.setIcon(new ImageIcon(getClass().getResource("/images/score.png"))); // NOI18N
    ...
    private JLabel lbCap1;
    private JLabel lbCap2;
    private JLabel lbCap3;
    private JLabel lbCup;
    private JLabel lbScoreLayout;
